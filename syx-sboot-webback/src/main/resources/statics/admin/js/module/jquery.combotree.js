...
$.fn.ComboTree = function (options, param) {
    ...
    opts = $.extend({}, $.fn.ComboTree.defaults, options);
    opts.target = this;
            ...
            $.ajax({
                ...
                success: function (data) {//msg为返回的数据，在这里做数据绑定
                    ...
                    opts.target.each(function () {
                        var method = $.fn.ComboTree.methods["init"];
                        method(this);
                    });
                },
...
$.fn.ComboTree.methods = {
    ...
    init: function (jq) {
        ...
        parentIdField = opts.parentIdField,
            dtHtml = '<dt class="sui-mselect"><a href="javascript:void (0);"></a></dt>',
            ulHtml = '<dd class="sui-option"><ul id="zd' + getRandom(999) + '" class="ztree" style=" overflow:auto;overflow-x:hidden"></ul>',
            html = '<dl class="sui-select-panel">' + dtHtml + ulHtml + '</dd></dl>';
        ...
        //设置默认的值
        var method = $.fn.ComboTree.methods["setValue"];
