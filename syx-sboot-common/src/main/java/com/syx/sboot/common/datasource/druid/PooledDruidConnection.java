...
class PooledDruidConnection implements InvocationHandler {
    private static final Logger log = LoggerFactory.getLogger(PooledDruidConnection.class);
    private static final String CLOSE = "close";
    private static final Class<?>[] IFACES = new Class[]{Connection.class};
    private int hashCode = 0;
    private PooledDruidDataSource dataSource;
    ...
    public PooledDruidConnection(Connection connection, PooledDruidDataSource dataSource) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof PooledDruidConnection?this.realConnection.hashCode() == ((PooledDruidConnection)obj).realConnection.hashCode():(obj instanceof Connection?this.hashCode == obj.hashCode():false);
    }
