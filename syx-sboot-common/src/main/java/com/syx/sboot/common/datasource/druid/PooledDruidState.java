...
public class PooledDruidState {
    protected PooledDruidDataSource dataSource;
    protected final List<PooledDruidConnection> idleConnections = new ArrayList();
    protected final List<PooledDruidConnection> activeConnections = new ArrayList();
    ...
    public PooledDruidState(PooledDruidDataSource dataSource) {
